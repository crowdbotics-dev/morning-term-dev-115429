"""
Django settings for morning_term_dev_115429 project.
...
ROOT_URLCONF = 'morning_term_dev_115429.urls'
...
WSGI_APPLICATION = 'morning_term_dev_115429.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "morning_term_dev_115429 API",
    "DESCRIPTION": "API documentation for morning_term_dev_115429 App",
    "VERSION": "v1",
}
